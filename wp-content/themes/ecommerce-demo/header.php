    ...
    <header class="fixed w-full z-50">
        <nav class="px-4 md:px-16 flex flex-row flex-wrap justify-between my-3 ml-auto mr-auto " role="navigation">
            ...
            <div class="flex items-center justify-between text-white -ml-4 md:-ml-0 w-full">
                <a href="/">
                    <svg class="h-6 lg:h-8" width="183" height="32" viewBox="0 0 183 32" fill="none"
                        ...
                        <path
                            ...
                            fill="white" />
                        <path d="M16 2V30" stroke="white" stroke-width="2" stroke-linecap="round"
                        ...
                        <path d="M12.3925 27C13.4821 26.3457 14.7291 26 16 26C17.2709 26 18.518 26.3457 19.6075 27"
                            stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M28.1244 9L3.87563 23" stroke="white" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path
                        ...
                        <path
                            ...
                            stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M3.87563 9L28.1244 23" stroke="white" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path
                ...
                <div id="nav-items" class="faded-out-left fixed md:relative items-center md:flex md:pr-4">
                    <?php 
                    wp_nav_menu( 
                    array( 
                        'theme_location' => 'main-menu',  
                        'container_class' => 'uppercase font-semibold [&>ul]:flex [&>ul]:items-center [&>ul]:gap-12 [&>ul]:list-none'
                    ) ); 
                    ?>
                    <a href="/cart" aria-label="Link to cart page" class="md:pl-12 flex justify-cente mt-12 md:mt-0">
